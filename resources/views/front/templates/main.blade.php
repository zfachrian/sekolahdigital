...
<head>
	<title>Sekolah Digital | @yield('title')</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<header class="py-4">
		<div class="container">
			<div id="logo">
				<h1> <a href="index.html"><span class="fa fa-cloud" aria-hidden="true"></span> Sekolah Digital</a></h1>
			</div>
			<!-- nav -->
			<nav class="d-lg-flex">
            ...
            <div class="col-lg-4 col-sm-6 footer-grid-wthree">
                ...
                <div class="contact-info">
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium ipsum doloremque
                        ...
                        doloremque elit dolor sit amet.</p>
